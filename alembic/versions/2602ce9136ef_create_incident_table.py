...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('affected_products', sa.String(50), nullable=False),
        sa.Column('severity', sa.String(50), nullable=False),
        sa.Column('suspected_owning_team', sa.String(50), nullable=False),
        ...
        sa.Column('suspected_affected_components', sa.String(50), nullable=False),
